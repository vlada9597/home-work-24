...
// Використання функції
const example2Array = [1, 2, 3, 4, 5]
const doubledArray = doubleArrayElements(example2Array)
...
function DateCalculator(initialDate) {
  ...
  // Метод для повернення дати у форматі YYYY-MM-DD
  this.getResult = function() {
    const year = this.date.getFullYear();
    const month = String(this.date.getMonth() + 1).padStart(2, '0'); // Місяці з 0 по 11
